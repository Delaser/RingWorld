...
The public repository starts from a clean MPL-2.0 root commit. Pre-public tag
names and commit hashes retained in engineering records are provenance labels
for the private development archive, not public Git objects. They do not make
the withdrawn MIT-labelled source version available through this repository.
