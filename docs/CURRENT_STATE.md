...
2026-08-27 latest checkpoint: the copied-world 26.2 stall is confirmed to be
...
The complete static workflow passes 328 tests. A fresh 26.2 frozen quick/nightly
run and copied-world upgrade gates remain required. See
