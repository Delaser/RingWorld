...
Selector thumbnails use the central 60% of each original screenshot (about 1.67× zoom), excluding the blue sky surround. Full-size captures and labelled comparison cards preserve the original framing. The editor screenshots above document the zoomed integration.
