...
> and the current suite passes 295 unit/parameterized cases per loader.
...
> Java 25 module builds with the same 295 tests; its dedicated server reaches
...
Both Fabric and NeoForge builds pass 295 unit/parameterized cases per loader.
