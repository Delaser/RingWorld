...
> and the current suite passes 292 unit/parameterized cases per loader.
...
> Java 25 module builds with the same 292 tests; its dedicated server reaches
...
Both Fabric and NeoForge builds pass 292 unit/parameterized cases per loader.
