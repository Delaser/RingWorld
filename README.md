...
> and the current suite passes 296 unit/parameterized cases per loader.
...
> thunder/lightning scenario also passes on both loaders. The physical portal
...
> Java 25 module builds with the same 296 tests; its dedicated server reaches
...
Both Fabric and NeoForge builds pass 296 unit/parameterized cases per loader.
