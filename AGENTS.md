...
gate. The Fabric and NeoForge builds each pass all 295 unit/parameterized
...
`build/libs/ringworld-0.2.0+mc26.1.2.jar`; the current suite contains 295
...
The NeoForge module uses the same Java 25 toolchain and also passes all 295
