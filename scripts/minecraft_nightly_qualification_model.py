...
_FIXTURES: tuple[tuple[NightlyFixture, str, str, int, tuple[str, ...], tuple[str, ...]], ...] = (
    ...
    (NightlyFixture.ATLAS_PREWARM_RECOVERY, SAFE_SMALL_PROFILE, "headless Atlas prewarm/recovery", NIGHTLY_SAFE_SMALL_TIMEOUT_SECONDS,
     ...
     ("terminal.json", "terminal.md", "settings.dat", "interrupted-result.json", "interrupted-atlas.rwat.gz",
      "interrupted-markers.json", "recovery-input-atlas.rwat.gz", "complete-result.json",
      "complete-atlas.rwat.gz", "recovery-markers.json")),
